...
fun! clighter#Enable()
    ...
    augroup ClighterEnable
        ...
        au TextChanged *.[ch],*.[ch]pp,*.m py clighter.ParsingService.invalidate_and_update_unsaved()
        au TextChangedI *.[ch],*.[ch]pp,*.m py clighter.ParsingService.invalidate_and_update_unsaved()
