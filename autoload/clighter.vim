...
fun! clighter#Enable()
    ...
    augroup ClighterEnable
        ...
        au TextChanged *.[ch],*.[ch]pp,*.m py clighter.ParsingService.update_sched_and_unsaved()
        au TextChangedI *.[ch],*.[ch]pp,*.m py clighter.ParsingService.update_sched_and_unsaved()
